...
export default function LinkedAccounts() {
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
      {msg && (
        <p style={{
          fontSize: '13px', color: 'var(--accent)', margin: '0 0 4px',
          padding: '10px 14px', background: 'var(--accent-bg)', borderRadius: '8px',
        }}>
          {msg}
        </p>
      )}
          ...
          >
            ...
            {isLinked ? (
              <button
                ...
                style={{
                  fontSize: '12px', padding: '6px 14px', borderRadius: '16px',
